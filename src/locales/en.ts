export default {
  ...
  preview: {
    deleteButton: 'Delete preview and drawing file',
    refreshButton: 'Refresh preview',
    editButton: 'Edit drawing',
    fullScreenButton: 'Full screen',
  },
  editor: {
    slidesMode: 'Slides Mode',
    exitButton: 'Save and exit',
    ...
    saveToast: {
      title: 'Saving...',
      description: 'When contains a lot of elements or images, it may take a while.',
    },
  },
  createDrawing: {
    tag: 'Excalidraw',
